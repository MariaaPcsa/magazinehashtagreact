...
const ProductCard = ({ id, name, brand, price, image, feminine }) => {
  return (
    <article className=" card-produto group w-48 bg-stone-100 shadow-xl shadow-slate-200 flex flex-col justify-around border-2 border-gray-200 rounded-lg w-full h-auto
">
      <img
        src={image}
